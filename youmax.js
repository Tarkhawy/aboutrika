...
*/
	...
	function loadYoumax() {		
		...
		function showInfo(response) {
			...
			$('#youmax-header').append('<div style="float:left; width:56%"><img style="vertical-align:middle; width:20%; margin: 8px; display:inline-block;" src="'+channelPic+'"/><span style="font-size:98%">'+channelName+'</span></div>');
			
			$('#youmax-header').append('<div style="float:left; width:17%"><a target="_blank" href="http://www.youtube.com/subscription_center?add_user='+youmaxUser+'"><img style="vertical-align:middle; margin: 8px;width:58%" src="http://s.ytimg.com/yt/img/creators_corner/Subscribe_to_my_videos/YT_Subscribe_64x64_red.png" alt="Subscribe to me on YouTube"/></a></div><div style="clear:both"></div>');
			...
			$('#youmax-stat-holder').append('<div class="youmax-stat"><span class="youmax-stat-count">'+getReadableNumber(channelSubscribers)+'</span><br/>subscribers</div>');
